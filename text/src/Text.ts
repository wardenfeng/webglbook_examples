namespace text
{
    ...
    export class Text
    {
         ...
         */
        private _styleListener: Function | null = null;
         ...
         */
        private drawLetterSpacing(text: string, x: number, y: number, isStroke = false)
        {
            const style = this._style;
         ...
         */
        _generateFillStyle(style: TextStyle, lines: string[])
        {
